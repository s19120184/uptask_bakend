...
export default function DashBoardView() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["projects"], //querykey deve ser unico
    queryFn: getProjects
  });
      ...
      <>
        ...
        <nav className="my-5">
          <Link
            ...
            to="/projects/create" //ruta a la que dirigira
          >
            {" "}
            Nuevo proyecto
          </Link>
                          ...
                          <>
                            ...
                            <MenuItem>
                              <button
                                ...
                                onClick={() => navigate(location.pathname + `?deleteProject=${project._id}`)} //pasamaos el id al mutate
                              >
                                Eliminar Proyecto
                              </button>
                            </MenuItem>
